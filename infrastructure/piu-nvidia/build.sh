MAGE_NAME=ubuntu_with_nvidia_driver
...
nvidia_url() {
    echo "https://http.download.nvidia.com/XFree86/Linux-x86_64/$(nvidia_host_version)/NVIDIA-Linux-x86_64-$(nvidia_host_version).run"
}
...
docker build -f Dockerfile -t piu .
